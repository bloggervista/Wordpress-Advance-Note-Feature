	...
	<div class="blog-posts grid-2-3">
		<?php if(have_posts()):while(have_posts()):the_post();?>
		   <article <?php echo post_class("module"); ?>  id="<?php the_ID(); ?>">
				...
				<h1><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">Things to Know : <?php the_title(); ?></a></h1>
				...
				<?php echo get_field('things_to_know');?>
